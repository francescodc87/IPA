"IPA.sampler.Iso.Add.CorrMat" <- function(P, Iso, Add, Int, Corr.matrix = NULL, corr.thr = 0.8, no.its = 1100, burn = 100, delta.iso = 0.5, delta.add = 0.5, allsamp = F, 
    ratio.toll = 0.8, allsampcomp = NULL, v = TRUE, IT = 500) {
