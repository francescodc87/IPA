#### Sampler one non-binary matrix - relation id


"IPA.sampler.One_Non_Binary_Matrix_relId" <- function(P, Iso, Int, rel.id, ratio.toll = 0.8, no.its = 1100, burn = 100, delta = 1, allsamp = F, allsampcomp = NULL, v = TRUE, 
    IT = 500) {
