#### Sampler one binary matrix - Filtering based on relation id - to be used only for ADD and ISO binary

"IPA.sampler.One_Binary_Matrix_relId" <- function(P, Add, rel.id, no.its = 1100, burn = 100, delta = 1, allsamp = F, allsampcomp = NULL, v = TRUE, IT = 500) {
