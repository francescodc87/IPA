#### ADD ISObin BIO - Correlation matrix filtering

"IPA.sampler.Add.IsoBin.Bio.CorrMat" <- function(P, Add, Iso, Bio, Corr.matrix, corr.thr = 0.8, no.its = 1100, burn = 100, delta.add = 0.5, delta.iso = 0.5, delta.bio = 1, 
    allsamp = F, allsampcomp = NULL, v = TRUE, IT = 500) {
