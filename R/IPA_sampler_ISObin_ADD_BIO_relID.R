...
"IPA.sampler.Add.IsoBin.Bio.relID" <- function(P, Add, Iso, Bio, rel.id, no.its = 1100, burn = 100, delta.add = 0.5, delta.iso = 0.5, delta.bio = 1, allsamp = F, allsampcomp = NULL, 
    v = TRUE, IT = 500) {
