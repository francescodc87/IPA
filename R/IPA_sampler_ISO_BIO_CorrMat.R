### ISO_BIO filtering with CorrMat


"IPA.sampler.Iso.Bio.CorrMat" <- function(P, Iso, Bio, Int, Corr.matrix = NULL, corr.thr = 0.8, no.its = 1100, burn = 100, delta.iso = 0.5, delta.bio = 1, allsamp = F, ratio.toll = 0.8, 
