"IPA.sampler.Add.Iso.Bio" <- function(P, Add, Iso, Bio, Int, no.its = 1100, burn = 100, delta.add = 0.5, delta.iso = 0.5, delta.bio = 1, allsamp = F, ratio.toll = 0.8, allsampcomp = NULL, 
    v = TRUE, IT = 500) {
