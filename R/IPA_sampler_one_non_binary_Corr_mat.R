#### Sampler one non-binary matrix - Correlation matrix


"IPA.sampler.One_Non_Binary_Matrix_CorrMat" <- function(P, Iso, Int, Corr.matrix, corr.thr = 0.8, ratio.toll = 0.8, no.its = 1100, burn = 100, delta = 1, allsamp = F, allsampcomp = NULL, 
    v = TRUE, IT = 500) {
