## ADD ISO BIO -- relatio id filtering

"IPA.sampler.Add.Iso.Bio.relID" <- function(P, Add, Iso, Bio, Int, rel.id, no.its = 1100, burn = 100, delta.add = 0.5, delta.iso = 0.5, delta.bio = 1, allsamp = F, ratio.toll = 0.8, 
