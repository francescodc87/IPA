...
"IPA.sampler.Two_Binary_Matrix_RT_Add_IsoBin" <- function(P, Add, Iso, RT, RT.win = 3, no.its = 1100, burn = 100, delta.add = 0.5, delta.iso = 0.1, allsamp = F, allsampcomp = NULL, 
    v = TRUE, IT = 500) {
