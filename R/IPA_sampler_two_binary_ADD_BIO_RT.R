### two binary matrices, filtering RT only for ADD, Bio RT


"IPA.sampler.Two_Binary_Matrix_RT_Add_Bio" <- function(P, Add, Bio, RT, RT.win = 3, no.its = 1100, burn = 100, delta.add = 0.5, delta.bio = 1, allsamp = F, allsampcomp = NULL, 
    v = TRUE, IT = 500) {
