### ISO_BIO filtering with RT


"IPA.sampler.Iso.Bio.RT" <- function(P, Iso, Bio, Int, RT = NULL, RT.win = 3, no.its = 1100, burn = 100, delta.iso = 0.5, delta.bio = 1, allsamp = F, ratio.toll = 0.8, allsampcomp = NULL, 
    v = TRUE, IT = 500) {
